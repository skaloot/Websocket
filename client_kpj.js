(function(global) {
        ...
        connection.onmessage = function(message) {
            ...
            if (json.type === "pong") {
                ...
                if(json.connected) {
                    ...
                    if(sessionStorage.getItem("myEmail")) {
    ...
    function change_title() {
        if (document.title !== "KPJ Selangor - Webchat") {
            document.title = "KPJ Selangor - Webchat";
            seen();
        }
    }
    ...
    var submit_register = function() {
        ...
        var names = $("#name").val();
        if(names == "" || names == " " || emails == "" || emails == " ") {
            return;
        }
        $("#error_reg").hide();
        // $.post("register.php", {name:names, email:emails}, function(data){
        $.post("http://www.kpjselangor.com/chat/register.php", {name:names, email:emails}, function(data){
            if(data.success) {
                $("#success_reg").show();
                show_login();
            } else {
    ...
    if (localStorage.getItem("myName") && sessionStorage.getItem("myEmail")) {
