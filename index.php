...
<html>
    ...
    <body>
        <div id="body">
            <div id="panel">
                <div class="panel" id="btn-quit">
                    <button class="btn" onclick="ska.quit()">Logout</button>
                </div>
				<div class="panel" id="btn-server">
					<button class="btn" onclick="ska.server_detail()">Server Detail</button>
				</div>
                <div class="panel" id="btn-restart">
                    <button class="btn" onclick="ska.restart()">Restart Server</button>
                </div>
        ...
        <?php if(isset($_GET["channel"])) { ?>
            if(!localStorage.channel) localStorage.channel = "<?php echo $_GET["channel"]; ?>";
